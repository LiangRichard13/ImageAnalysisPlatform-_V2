...
class ViTill(nn.Module):
    ...
    def forward(self, x):
        ...
        if hasattr(self, 'prompt'):
            ...
            self.reduce_sim = res['reduce_sim']
        ...
        return en, de
    # en → Encoder 侧融合后的特征图列表，元素 shape [B, C, H, W]
    # de → Decoder 侧融合后的特征图列表，元素 shape [B, C, H, W]
